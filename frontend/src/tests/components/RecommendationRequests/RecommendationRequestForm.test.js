...
describe("RecommendationRequestForm tests", () => {
    ...
    test("Correct Error messsages on bad input", async () => {
        ...
        await screen.findByTestId("RecommendationRequestForm-quarterYYYYQ");
        const quarterYYYYQField = screen.getByTestId("RecommendationRequestForm-quarterYYYYQ");
        const localDateTimeField = screen.getByTestId("RecommendationRequestForm-localDateTime");
