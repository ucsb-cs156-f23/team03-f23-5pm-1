...
describe("AppNavbar tests", () => {
    ...
    test("renders the recommendationrequests link correctly", async () => {
        ...
        expect(link).toBeInTheDocument();
        expect(link.getAttribute("href")).toBe("/recommendationrequests");
    });
    ...
    test("Restaurant, UCSBDates, and RecommendationRequests links do NOT show when not logged in", async () => {
        ...
        expect(screen.queryByText("RecommendationRequests")).not.toBeInTheDocument();
    });
