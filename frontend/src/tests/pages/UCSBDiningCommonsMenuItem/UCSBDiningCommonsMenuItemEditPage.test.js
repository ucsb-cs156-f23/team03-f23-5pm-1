...
describe("UCSBDiningCommonsMenuItemEditPage tests", () => {
    ...
    describe("tests where backend is working normally", () => {
        ...
        test("Is populated with the data provided", async () => {
            ...
            expect(stationField).toHaveValue("special entree");
        ...
        test("Changes when you click Update", async () => {
            ...
            fireEvent.change(nameField, { target: { value: 'cheeseburger' } })
            ...
            expect(mockToast).toBeCalledWith("UCSBDiningCommonsMenuItem Updated - id: 17 name: cheeseburger diningCommonsCode: ortega station: entree");
